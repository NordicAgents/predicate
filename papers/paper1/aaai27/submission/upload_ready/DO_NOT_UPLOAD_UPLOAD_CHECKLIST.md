...
- Main paper: 6 US-Letter pages; page 6 contains references only.
- Supplement: 2 US-Letter pages.
...
- Code/data ZIP: 365 regular-file members, deterministic timestamps, no hidden
...
- Clean extracted archive: offline dependency installation completed; all 57
