...
## Automatically verified on 2026-07-29

- Main paper: 7 US-Letter pages; content ends on page 6 and references occupy
  pages 6--7.
...
- Code/data ZIP: 379 regular-file members, deterministic timestamps, no hidden
...
- Clean extracted archive: offline dependency installation completed; all 65
...
- [ ] Confirm the downloaded main paper has 7 pages and displays
